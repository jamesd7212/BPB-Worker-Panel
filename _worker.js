...
let userID = 'f375587a-b321-4bec-9580-0b5baa976e29';
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    default:
                        ...
                        url.hostname = 'www.kankanews.com';
                        url.protocol = 'https:';
...
async function buildXrayDNSObject (remoteDNS, localDNS, blockAds, bypassIran, bypassChina, blockPorn, isWorkerLess) {
    ...
    if (isWorkerLess) {
        ...
        const resolvedCLDomain = await resolveDNS('www.kankanews.com.cdn.cloudflare.net');
